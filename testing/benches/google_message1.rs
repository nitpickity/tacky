...
//! would be worse.
//!
//! Wire output is checked by decoding tacky's bytes with prost and comparing the messages.
...
/// emits.
fn tacky_encode_p2<B: tacky::WriteBuf>(buf: &mut B, m: &prost_p2::GoogleMessage1) {
...
fn tacky_encode_p3<B: tacky::WriteBuf>(buf: &mut B, m: &prost_p3::GoogleMessage1) {
