...
`tacky-build` vendors a copy of [pb-rs](https://github.com/tafia/quick-protobuf/tree/master/pb-rs) (from the [quick-protobuf](https://github.com/tafia/quick-protobuf) project, MIT-licensed) to parse and validate `.proto` files at build time. We use it as a parser only — the schema and decoder code is generated by tacky — and vendoring it keeps the build free of any `protoc` system dependency.
